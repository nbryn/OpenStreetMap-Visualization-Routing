...
class AddressDataTest {
    ...
    void putAddress() {
        ...
        addressData.putAddress(23232, address);
    ...
    void getAddresses() {
        addressData.getAddresses().clear();
        addressData.putAddress(23232, new Address("Farum", "21", "3520", "2", 21, 22, 25));
    ...
    @Test
    void search() {
        addressData.putAddress(1, new Address("Samsoe", "1", "1234", "Smediegyde", 1, 1, 321));
